...
export const norwegianMessages = {
  ...
  'shortcuts.open': 'Hurtigtaster',
  'shortcuts.heading': 'Hurtigtaster',
  'shortcuts.description': 'Gå raskt gjennom løsningen uten å forlate tastaturet.',
  'shortcuts.close': 'Lukk hurtigtaster',
  'shortcuts.search': 'Søk i emner',
  'shortcuts.searchHelp': 'Åpne Utforsk og sett fokus på emnesøket.',
  'shortcuts.help': 'Vis hurtigtaster',
  'shortcuts.helpHelp': 'Åpne denne veiledningen når fokus ikke er i et tekstfelt.',
  'shortcuts.dismiss': 'Lukk dialogvinduer',
  'shortcuts.dismissHelp': 'Flytt fokus tilbake til elementet som åpnet dialogvinduet.',
  ...
  'appearance.fjordDescription': 'Smaragd over kjølig dis med indigodiagrammer.',
  ...
  'list.originFilter': 'Vis emner fra',
  ...
  'list.save': 'Lagre',
  'list.remove': 'Fjern',
  'list.savedStatus': 'Lagret {code} i listen.',
  'list.removedStatus': 'Fjernet {code} fra listen.',
  'list.removedManyStatus': 'Fjernet {count} emner fra listen.',
  'list.undo': 'Angre',
  ...
  'list.redo': 'Gjør om',
  'list.undidSaveStatus': 'Angret lagring av {code}.',
  'list.restoredStatus': 'Gjenopprettet {code} i listen.',
  'list.restoredManyStatus': 'Gjenopprettet {count} emner i listen.',
  'list.redoSave': 'Gjør om lagring av {code}',
  'list.redoRemove': 'Gjør om fjerning av {code}',
  'list.redoRemoveMany': 'Gjør om fjerning av {count} emner',
  'list.dismissStatus': 'Lukk',
  'list.dismissAllStatus': 'Lukk alle {count} varsler',
  ...
  'signals.workloadTiming': 'Arbeidsrytme',
  'signals.timingDistributed': 'Fordelt gjennom semesteret',
  'signals.timingConcentrated': 'Konsentrert periode',
  'signals.timingRecurring': 'Gjentakende arbeid',
  'signals.timingMilestone': 'Milepælsbasert',
  'signals.timingUnknown': 'Tidspunkt ikke publisert',
  'signals.attendance': 'Oppmøte',
  'signals.attendanceRequired': 'Obligatorisk oppmøte',
  'signals.attendanceNotRequired': 'Ingen oppmøteplikt',
  'signals.officialSource': 'Offisiell emnekilde ↗',
  'signals.checked': 'Kontrollert {date}',
  'signals.openSchedule': 'Ukeplan',
  ...
  'detail.count': 'Antall',
  'detail.share': 'Andel',
  'detail.sources': 'Referanser',
  'detail.sourcesHelp':
    'Kildeoppføringer for emnet vises én gang her. Manglende, utledede og motstridende fakta forblir merket der de vises.',
