...
const en = {
  ...
  'collection.all': 'All saved courses',
  'collection.select': 'Show collection',
  'collection.save': 'Save as collection',
  'collection.cancel': 'Cancel',
  'collection.name': 'Collection name',
  'collection.namePlaceholder': 'Autumn shortlist, Ask adviser',
  'collection.apply': 'Save collection',
  'collection.delete': 'Delete collection',
  'collection.deleteNamed': 'Delete the collection {name}',
  'collection.deleteHelp': 'Deleting a collection removes the question, never the saved courses.',
  'collection.emptyName': 'A collection needs a name.',
  'collection.duplicateName': 'You already have a collection with that name.',
  'collection.inactiveFilter':
    'Filter the list first — a collection without a filter is the whole saved list.',
  'collection.limitReached': 'You have as many collections as this release supports.',
  'collection.activeNamed': 'Showing the collection {name}.',
...
const nb = {
  ...
  'nav.explore': 'Utforsk',
  'nav.degree': 'Studie',
  'nav.degreeAccessible': 'Fullstendig studieoversikt',
  'nav.more': 'Mer',
  ...
  'collection.heading': 'Samlinger',
  'collection.all': 'Alle lagrede emner',
  'collection.select': 'Vis samling',
  'collection.save': 'Lagre som samling',
  'collection.cancel': 'Avbryt',
  'collection.name': 'Navn på samlingen',
  'collection.namePlaceholder': 'Aktuelt til høsten, Spør veileder',
  'collection.apply': 'Lagre samlingen',
  'collection.delete': 'Slett samlingen',
  'collection.deleteNamed': 'Slett samlingen {name}',
  'collection.deleteHelp': 'Å slette en samling fjerner spørsmålet, aldri de lagrede emnene.',
  'collection.emptyName': 'En samling trenger et navn.',
  'collection.duplicateName': 'Du har allerede en samling med det navnet.',
  'collection.inactiveFilter':
    'Filtrer listen først — en samling uten filter er hele den lagrede listen.',
  'collection.limitReached': 'Du har like mange samlinger som denne versjonen støtter.',
  'collection.activeNamed': 'Viser samlingen {name}.',
