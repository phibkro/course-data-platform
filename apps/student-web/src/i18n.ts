...
export const englishMessages = {
  ...
  'list.save': 'Save',
  'list.remove': 'Remove',
  'list.savedStatus': 'Saved {code} to List.',
  'list.removedStatus': 'Removed {code} from List.',
  'list.removedManyStatus': 'Removed {count} courses from List.',
  'list.undo': 'Undo',
  'list.undoSave': 'Undo saving {code}',
  'list.undoRemove': 'Undo removing {code}',
  'list.undoRemoveMany': 'Undo removing {count} courses',
  'list.redo': 'Redo',
  'list.undidSaveStatus': 'Undid saving {code}.',
  'list.restoredStatus': 'Restored {code} to List.',
  'list.restoredManyStatus': 'Restored {count} courses to List.',
  'list.redoSave': 'Redo saving {code}',
  'list.redoRemove': 'Redo removing {code}',
  'list.redoRemoveMany': 'Redo removing {count} courses',
  'list.dismissStatus': 'Dismiss',
  'list.dismissAllStatus': 'Dismiss all {count} notices',
