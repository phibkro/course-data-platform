...
export const englishMessages = {
  ...
  'shortcuts.description': 'Move quickly without leaving the keyboard.',
  'shortcuts.close': 'Close keyboard shortcuts',
  'shortcuts.search': 'Search courses',
  'shortcuts.searchHelp': 'Open Explore and focus the course search.',
  'shortcuts.help': 'Show keyboard shortcuts',
  'shortcuts.helpHelp': 'Open this guide when focus is not in a text field.',
  'shortcuts.dismiss': 'Close dialogs',
  'shortcuts.dismissHelp': 'Return focus to what opened the dialog.',
  ...
  'appearance.fjordDescription': 'Emerald over cool mist with indigo charts.',
  ...
  'list.originFilter': 'Show courses from',
  ...
  'signals.workloadTiming': 'Workload timing',
  'signals.timingDistributed': 'Spread through the term',
  'signals.timingConcentrated': 'Concentrated period',
  'signals.timingRecurring': 'Recurring work',
  'signals.timingMilestone': 'Milestone-based',
  'signals.timingUnknown': 'Timing not published',
  'signals.attendance': 'Attendance',
  'signals.attendanceRequired': 'Required attendance',
  'signals.attendanceNotRequired': 'No attendance requirement',
  'signals.officialSource': 'Official course source ↗',
  'signals.checked': 'Checked {date}',
  'signals.openSchedule': 'Weekly schedule',
  ...
  'detail.sourcesHelp':
    'Source records for this course are listed once here. Missing, inferred, and conflicting facts stay marked where they appear.',
